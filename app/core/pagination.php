...
class Pagination
{
    ...
    public function render()
    {
        ...
        // Previous button
        $html .= '<li class="page-item' . ($this->currentPage == 1 ? ' disabled' : '') . '"><a class="page-link" href="' . $this->getPageUrl($this->currentPage - 1) . '" aria-label="Previous"><span aria-hidden="true">&laquo;</span><span class="sr-only">Prev</span></a></li>';
        
        // First page
        if ($this->totalPages > 1) {
            $html .= '<li class="page-item' . ($this->currentPage == 1 ? ' active' : '') . '"><a class="page-link" href="' . $this->getPageUrl(1) . '">&#8249;</a></li>';
        }
        ...
        // Last page
        if ($this->totalPages > 1) {
            $html .= '<li class="page-item' . ($this->currentPage == $this->totalPages ? ' active' : '') . '"><a class="page-link" href="' . $this->getPageUrl($this->totalPages) . '"> &#8250;</a></li>';
        }
